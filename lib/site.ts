export const site = {
  ...
  heroSub:
    "AIで世の中の変化が加速してる時代、変化に追いつくだけでは必要なくなる。変化を活かし価値を出し続ける新しいAI時代のプロダクト開発を行なっています。",
  bio:
...
export const services = [
  ...
  { no: "03", title: "プロダクト構築運用", desc: "既存業務の自動化から新規事業の開発運用まで大規模ECに最前線で向き合っている知見で継続的に価値を出します。" },
];
